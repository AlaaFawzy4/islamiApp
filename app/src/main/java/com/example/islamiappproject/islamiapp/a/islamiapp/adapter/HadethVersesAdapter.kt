...
import com.example.islamiappproject.databinding.ItemHadethVerseBinding
import com.example.islamiappproject.databinding.ItemSuraVerseBinding

class HadethVersesAdapter(var list:List<String>?) :Adapter<HadethVersesAdapter.viewHolder>(){
var onHadethClickListener:OnHadethClickListener?=null

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): viewHolder {
        val bind= ItemHadethVerseBinding.inflate(LayoutInflater.from(parent.context),parent,false)
    ...
    class viewHolder(var binding:ItemHadethVerseBinding):RecyclerView.ViewHolder(binding.root){
